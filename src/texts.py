...
class Texts:
    TEXTS = {
        ...
        "ru": {
            ...
            "seminar_info": (
                "Спасибо за интерес! 🙏\n\n"
                "У Вас есть ОСОБОЕ ПРЕДЛОЖЕНИЕ.\n"
                "🎤 СЕМИНАР — 14 ФЕВРАЛЯ\n\n"
                "⏰ Время: 14:00 — 18:00\n"
                "📍 Ташкент (адрес позже)\n\n"
                "Во время семинара:\n"
                "🎬 Ролик на 1 МИЛЛИОН — создам ПРИ ВАС\n"
                "💰 Как заработал $7000 за 2 недели — расскажу все\n"
                "🤖 4 AI инструмента — покажу на практике\n"
                "💼 Кому продавать и КАК — секреты поиска клиентов\n"
                "🎯 ОСОБЫЙ ГОСТЬ: Шохидахон — сильнейший таргетолог\n"
                "❓ Вопросы-ответы — живое общение\n\n"
                "━━━━━━━━━━━━━━━\n"
                "2 ТАРИФА:\n"
                "🏢 ОФЛАЙН — 99 000 сум\n"
                "В Ташкенте, лично\n"
